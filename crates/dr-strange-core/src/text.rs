...
/// The list itself, held apart from the function that interns it: it is data,
/// and a reader scanning `english_stopwords` for behaviour should not have to
/// page through it to find that there is none.
