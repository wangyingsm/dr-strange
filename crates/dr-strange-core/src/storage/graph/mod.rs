...
pub use meta::{
    DEFAULT_PLANE_NAME, FORMAT_VERSION, create_plane, declare_vector_index, drop_plane, init,
    intern_edge_type, intern_label, list_planes, list_vector_indexes, lookup_edge_type,
    lookup_label, plane_id_by_name, read_plane, rename_plane, resolve_label, set_plane_properties,
};
