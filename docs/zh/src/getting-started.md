...
```console
$ drsg update
drsg 2.9.1 is the latest release — nothing to do
```
...
$ drsg update
drsg 2.9.0 -> 2.9.1
$ curl -fsSL https://raw.githubusercontent.com/wangyingsm/dr-strange/v2.9.1/scripts/install.sh | sh -s -- --bin 'drsg' --version 'v2.9.1' --dir '/home/me/.local/bin'
Dr Strange v2.9.1 (x86_64-unknown-linux-gnu)
  downloading dr-strange-v2.9.1-x86_64-unknown-linux-gnu.tar.gz
  checksum verified
