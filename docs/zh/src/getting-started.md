...
```console
$ drsg update
drsg 2.11.0 is the latest release — nothing to do
```
...
$ drsg update
drsg 2.10.0 -> 2.11.0
$ curl -fsSL https://raw.githubusercontent.com/wangyingsm/dr-strange/v2.11.0/scripts/install.sh | sh -s -- --bin 'drsg' --version 'v2.11.0' --dir '/home/me/.local/bin'
Dr Strange v2.11.0 (x86_64-unknown-linux-gnu)
  downloading dr-strange-v2.11.0-x86_64-unknown-linux-gnu.tar.gz
  checksum verified
